...
class RoomCreateForm(forms.ModelForm):
    class Meta:
        ...
        maintenance_schedule = forms.ModelChoiceField(queryset=House.objects.all(), widget=forms.Select(attrs={'class': 'form-control'}))
...
# 
        widgets = {
            ...
            'discard_date': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
